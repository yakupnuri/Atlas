...
export default function AdminHeroSlidesPage() {
  ...
  const closeModal = () => {
    ...
    setFormData({
      ...
      order: 0,
      isActive: true,
      badge: { text: '', color: 'blue', enabled: false }
    });
  };
                ...
                <div className="flex">
                  ...
                  <div className="flex-1 p-6">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600 mb-4">
                      ...
                      {slide.badge?.enabled && slide.badge?.text && (
                        <span className="flex items-center gap-2">
                          Badge: 
                          <span className={`px-2 py-1 text-xs rounded-full ${
                            slide.badge.color === 'blue' ? 'bg-blue-100 text-blue-800' :
                            slide.badge.color === 'green' ? 'bg-green-100 text-green-800' :
                            slide.badge.color === 'red' ? 'bg-red-100 text-red-800' :
                            slide.badge.color === 'yellow' ? 'bg-yellow-100 text-yellow-800' :
                            slide.badge.color === 'purple' ? 'bg-purple-100 text-purple-800' :
                            'bg-pink-100 text-pink-800'
                          }`}>
                            {String(slide.badge.text)}
                          </span>
                        </span>
                      )}
                    </div>
