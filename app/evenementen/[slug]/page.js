          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {event.volunteers && event.volunteers.length > 0 && (
              <motion.div
                ...
                className="bg-white rounded-lg p-6 shadow-md"
              >
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Organisatieteam</h2>
                <p className="text-gray-600 mb-4">Dit evenement wordt georganiseerd door onze toegewijde vrijwilligers</p>
                <div className="space-y-3">
                  {event.volunteers.map((volunteer, index) => (
                    <div key={index} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <div className="w-10 h-10 bg-gradient-to-br from-[#05B6C4] to-[#3B87BE] rounded-full flex items-center justify-center text-white font-semibold">
                        {volunteer.charAt(0).toUpperCase()}
                      </div>
                      <div>
                        <p className="font-semibold text-gray-800">{volunteer}</p>
                        <p className="text-sm text-gray-500">Vrijwilliger</p>
                      </div>
                    </div>
                  ))}
                </div>
