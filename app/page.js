          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/academie"
                  className="inline-flex items-center justify-center gap-2 bg-white text-[#05B6C4] px-8 py-4 rounded-xl font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all"
                >
              ...
              <div className="mt-12 flex items-center gap-6 text-white/80">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">ANBI Erkend</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-green-300" />
                  <span className="text-sm">500+ Deelnemers</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-green-300" />
