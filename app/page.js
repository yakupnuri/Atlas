        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <div className="bg-gradient-to-br from-purple-600 via-pink-500 to-red-500 rounded-2xl shadow-2xl p-6" style={{ height: '600px' }}>
                    ...
                    announcements.slice(0, 5).map((announcement, index) => (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <div className="bg-gradient-to-br from-pink-500 to-red-500 p-2 rounded-lg flex-shrink-0 group-hover:scale-110 transition-transform">
                            <Bell className="w-4 h-4 text-white" />
                          </div>
                          <div className="flex-1 min-w-0">
                            <h4 className="font-bold text-gray-900 text-sm mb-1 group-hover:text-pink-600 transition-colors line-clamp-2">
                              {announcement.title}
                            </h4>
                            ...
                            <div className="mt-2 flex items-center gap-2">
                              <div className="h-1 w-12 bg-gradient-to-r from-pink-500 to-red-500 rounded-full group-hover:w-16 transition-all"></div>
                              <span className="text-xs text-pink-600 font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
                                Lees meer →
                              </span>
                            </div>
                          </div>
